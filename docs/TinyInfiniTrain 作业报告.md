...
<img width="1448" height="535" alt="image" src="https://github.com/user-attachments/assets/23153213-b97c-4f53-9b4f-2760fc94abf2" />
考虑到每次都是固定几个点出问题，故考虑是显卡型号问题，先后用4090和5090对作业6进行测试，发现误差点一样但是误差值不一样，于是考虑用A100进行测试，这次顺利通过。
